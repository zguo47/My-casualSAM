...
class DavisVideoDataset(DepthVideoDataset):
    ...
    def get_paths(self, opt):
        ...
        data_list_root = "/fs/nexus-projects/video-depth-pose/videosfm/datasets/sora_frames_zip/sora_frames_50frames/sora_frames_4"
        mask_root = "/fs/nexus-projects/video-depth-pose/videosfm/datasets/sora_frames_zip/sora_frames_50frames/sora_frames_4"
        image_path = join(data_list_root, f"{track_name}")
        self.paths = {
            "image_path": image_path,
            "mask_path": join(mask_root, f"{track_name}"),
